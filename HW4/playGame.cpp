...
void menu(vector<Hex> allGames)
{
    ...
    while (exitFirst)
    {
        ...
        case 2:
            ...
            if (Hex::numGames()!=0)
            {
                ...
                if(num!=0)
                {
                    ...
                    {
                        cout << "\033[2J\033[1;1H";
                        cout << allGames[num-1]; //Operator overloading
        ...
        case 3:
            ...
            {
                cout << "\033[2J\033[1;1H";
                cout << allGames[findGame(allGames,gname)]; //Operator overloading
        ...
        case 4:
            ...
            for (i = 0; i <Hex::numGames(); i++)
            {
                ...
                if (allGames[i].getGameMode()==1)
                    ...
                    cout <<"PvC" << endl;
                cout <<"PLAYER 1 SCORE: "<< allGames[i].getScoreX()*(100.0/(double)(allGames[i].getHeight()-1))<< endl;
                if (allGames[i].getGameMode()==1)
                    cout <<"PLAYER 2 SCORE: " <<allGames[i].getScoreO()*(100.0/(double)(allGames[i].getHeight()-1))<< endl;
                else 
                    cout <<"COMPUTER SCORE: "<<allGames[i].getScoreO()*(100.0/(double)(allGames[i].getHeight()-1))<< endl;
                cout <<"IS FINISHED?: ";
                if (allGames[i].isEnd())
                    cout << " YES" << endl;
                else 
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                cout << allGames[gm1-1].getGameName() << " AND " <<  allGames[gm2-1].getGameName() << " HAVE EQUAL MARKED CELLS" << endl;
                            }
                            else 
                                cout << allGames[gm1-1].getGameName() << " AND " <<  allGames[gm2-1].getGameName() << " HAVE NOT EQUAL MARKED CELLS" << endl;
                            cout << "Press 0 to back to Main Menu"<<endl;
                            while (true)
                            {
                                cin >> num;
